...
const services = [
  ...
  { slug: "website-development/nextjs", name: "Next.js Development" },
  { slug: "website-development/react", name: "React Development" },
  { slug: "website-development/full-stack", name: "Full-Stack Solutions" },
  { slug: "wordpress-development", name: "WordPress Development" },
  { slug: "ecommerce-development", name: "Shopify Development" },
  { slug: "web-application", name: "Web Application Development" },
  { slug: "website-maintenance", name: "Website Maintenance" },
  { slug: "application-maintenance", name: "Application Maintenance" },

  // Digital Marketing
  { slug: "seo", name: "Search Engine Optimization (SEO)" },
  { slug: "social-media-marketing", name: "Social Media Marketing" },
  { slug: "social-media-promotions", name: "Social Media Promotions" },
  { slug: "performance-marketing", name: "Performance Marketing" },
  { slug: "ppc-google-ads", name: "Google Ads / PPC" },
  { slug: "meta-ads", name: "Meta / Facebook Ads" },
  ...
  { slug: "whatsapp-marketing", name: "WhatsApp Campaigns" },
  { slug: "sms-marketing", name: "SMS Marketing" },
  { slug: "influencer-management", name: "Influencer Management" },
  { slug: "youtube-seo", name: "YouTube SEO" },
  { slug: "media-planning-buying", name: "Media Planning & Buying" },
  { slug: "political-digital-marketing", name: "Political Digital Marketing" },

  // Branding & Creative
  { slug: "branding-consulting", name: "Branding Consulting" },
  { slug: "brand-strategy", name: "Brand Strategy & Consulting" },
  {
    slug: "brand-marketing-communications",
    name: "Brand Marketing Communications",
  },
  { slug: "brand-name", name: "Brand Name Creation" },
  { slug: "logo-design", name: "Logo Design" },
  { slug: "brand-identity", name: "Brand Identity Development" },
  { slug: "branding-design", name: "Branding & Design" },
  { slug: "brochure-design", name: "Brochure Designing" },
  { slug: "business-card-design", name: "Business Card Design" },
  { slug: "letterhead-design", name: "Letterhead Design" },
];

function generateTemplate(name, slug) {
...
export const metadata: Metadata = {
  title: "${name} Services in Pune | Growthik Media",
  description:
    "Looking for a professional ${name} company in Pune? We provide custom, SEO-optimized, ${name} services for businesses. Call Now!",
  keywords:
    "${name} Company in Pune, SEO Company in Pune, Digital Marketing Agency in Pune, Custom ${name} Pune",
  alternates: {
    canonical: \`\${CONTACT_INFO.website}/services/${slug}\`,
  },
};
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-black mb-4 uppercase tracking-tight text-(--text-primary)">
              Professional ${name} for Modern Businesses
            </h2>
            ...
            <p className="text-(--text-secondary) font-medium text-lg max-w-2xl mx-auto">
              ...
              ${name} services that look premium and perform exceptionally.
            </p>
          </div>
      ...
      <section className="px-6 lg:px-12 py-20 bg-(--surface) border-t border-(--border)">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
          <div className="lg:w-1/2">
            <h2 className="text-3xl md:text-4xl font-black mb-4 uppercase tracking-tight text-(--text-primary)">
              ${name} with Built-In ROI Advantage
            </h2>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            <h2 className="text-3xl font-black mb-4 uppercase tracking-tight text-(--text-primary)">
              Importance of ${name} for Business Growth
            </h2>
...
for (const s of services) {
  // Use replace to properly handle windows path delimiters
  const slugParts = s.slug.split("/");

  // Skip the already explicitly created pages for safety
  if (s.slug === "website-design" || s.slug === "website-design-company-pune")
    continue;

  const dir = path.join(
    "d:/Company/Growthikmedia.com/Website/GrowthikMedia.com/app/(public)/services",
    ...slugParts,
  );
  ...
  fs.writeFileSync(
    ...
    generateTemplate(s.name, s.slug),
    "utf8",
  );
