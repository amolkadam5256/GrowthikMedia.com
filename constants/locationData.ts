import { Monitor, Globe, Search, Target, Zap, BarChart, LucideIcon } from "lucide-react";
...
export const locationMapping: Record<string, LocationData> = {
  "website-design-company-in-aundh": {
    ...
    description: "Top web design company in Aundh, Pune. We build fast, SEO-optimized, conversion-focused websites for local businesses. Get a free quote today.",
    keywords: "website design company in aundh, web design aundh pune, website development aundh, best web design company aundh",
    ogTitle: "Best Web Design Company in Aundh Pune | Growthik Media",
    ogDescription: "Top-rated website design company in Aundh, Pune — fast, SEO-optimized websites that convert visitors into customers.",
    area: "Aundh",
    city: "Pune",
    ...
    faqs: [
      { q: "How much does a website cost for a business in Aundh?", a: "Website costs in Aundh vary from ₹15,000 for a simple brochure site to ₹1,50,000+ for a custom business website. eCommerce sites start from ₹80,000. We offer transparent pricing with no hidden charges — contact us for a detailed quote." },
      { q: "How long does it take to build a website?", a: "A standard business website typically takes 3–5 weeks from discovery to launch. eCommerce sites take 6–10 weeks. We provide a clear project timeline before we begin." },
      { q: "Will my website rank on Google?", a: "Every website we build includes on-page SEO setup, schema markup, Core Web Vitals optimization, and Google Search Console integration. We also offer ongoing SEO services to continuously improve your rankings in Aundh and across Pune." },
      { q: "Do you offer website maintenance after launch?", a: "Yes, we offer monthly maintenance packages covering security updates, content edits, performance optimization, and technical support so your website stays fast, secure, and up-to-date." },
    ],
  },
  "website-design-company-in-baner": {
    title: "Web Design Company in Baner Pune | Growthik Media",
    description: "Best web design company in Baner, Pune. We build fast, SEO-optimized, and conversion-focused websites for local businesses. Get a free quote today.",
    keywords: "website design company baner, web design baner pune, website development baner, best web design company baner pune",
    ogTitle: "Web Design Company in Baner Pune | Growthik Media",
    ogDescription: "Best website design company in Baner, Pune — premium websites for startups, agencies, and businesses in Baner & Balewadi area.",
    area: "Baner",
    city: "Pune",
    primaryService: "Website Design Company",
    ...
    faqs: [
      { q: "What makes Growthik Media the best website design company in Baner?", a: "We combine three things that most agencies in Baner lack: premium design quality, technical performance excellence (90+ PageSpeed), and SEO built into every website from day one. We also offer transparent pricing and dedicated account management." },
      { q: "Do you design websites for restaurants and cafes in Baner?", a: "Yes. We have experience building visually stunning websites for restaurants and hospitality businesses in Baner — complete with menu displays, photo galleries, online reservations, Google Maps integration, and local SEO for food-related searches." },
      { q: "What is the cost of a website for a startup in Baner?", a: "Startup websites typically cost ₹25,000–₹1,50,000 depending on the features required. We offer startup-friendly packages that include product/service pages, an about page, team section, contact form, and basic SEO setup." },
      { q: "Can you help with digital marketing beyond just the website?", a: "Absolutely. We offer a full suite of digital marketing services — SEO, Google Ads, Meta Ads, social media management, and content marketing — making us a single-vendor solution for your entire digital presence in Baner." },
    ],
  },
  "website-design-company-in-hadapsar": {
    title: "Website Development in Hadapsar Pune | Growthik Media",
    description: "Expert website development in Hadapsar, Pune. Custom, SEO-optimized websites for businesses in Hadapsar. Fast delivery, transparent pricing. Get a free quote.",
    keywords: "website development hadapsar, web design hadapsar pune, website design company hadapsar, best web development hadapsar pune",
    ogTitle: "Website Development in Hadapsar Pune | Growthik Media",
    ogDescription: "Expert website development in Hadapsar, Pune — custom, SEO-ready websites for businesses of all sizes. Free quote available.",
    area: "Hadapsar",
    city: "Pune",
    ...
    faqs: [
      { q: "What technologies do you use for website development in Hadapsar?", a: "We primarily build with Next.js (React) for high-performance web apps and WordPress for content-managed websites. We choose the technology stack based on your specific requirements, budget, and long-term maintenance needs." },
      { q: "Can you develop a website for a manufacturing or industrial company in Hadapsar?", a: "Yes. We have experience building B2B and manufacturing websites with product catalogs, industrial specification pages, ISO certification showcases, and inquiry management systems — all optimized for Google B2B searches." },
      { q: "How long does website development take?", a: "A standard 10-15 page business website takes 3–5 weeks. Complex web applications or eCommerce sites take 8–14 weeks. We provide a detailed project timeline during the proposal phase." },
      { q: "Do you guarantee website speed and performance?", a: "Yes. Every website we develop is optimized to achieve 90+ Google PageSpeed scores on mobile and desktop, with zero Cumulative Layout Shift (CLS), fast Largest Contentful Paint (LCP), and excellent Core Web Vitals — a critical ranking factor in 2025." },
    ],
  },
  "website-design-company-in-kothrud": {
    title: "Web Design Company in Kothrud Pune | Growthik Media",
    description: "Best web design company in Kothrud, Pune. We create modern, fast, and SEO-optimized websites for local businesses. Get a free quote today.",
    keywords: "website design company kothrud, web design kothrud pune, website development kothrud, best web design company kothrud pune",
    ogTitle: "Web Design Company in Kothrud Pune | Growthik Media",
    ogDescription: "Best website design company in Kothrud, Pune — modern, fast, SEO-ready websites that convert. Free consultation available.",
    area: "Kothrud",
    city: "Pune",
    primaryService: "Website Design Company",
    ...
    faqs: [
      { q: "Which types of businesses in Kothrud do you typically work with?", a: "We work with a wide range of Kothrud businesses: clinics and hospitals, coaching institutes, law firms, restaurants, real estate agencies, retail shops, coaching classes, and professional service providers." },
      { q: "Does the website you build appear in local Kothrud searches?", a: "Yes. Our process includes Google Business Profile setup and optimization, local schema markup, Kothrud-specific keyword targeting, and NAP consistency across directories — giving your site maximum visibility for local searches." },
      { q: "What is the cost of a website in Kothrud?", a: "A professional website for a Kothrud business starts at ₹15,000 for a simple 5-page site and can go up to ₹1,50,000+ for a fully custom solution. We tailor our proposals to your specific needs and budget." },
      { q: "Do you provide content writing for the website?", a: "Yes, we offer professional copywriting and content creation as part of our website packages. Our content is SEO-optimized, conversion-driven, and written in a tone that resonates with your target audience." },
    ],
  },
  "website-design-company-in-pcmc": {
    title: "Website Design in PCMC Pune | Growthik Media",
    description: "Professional website design in PCMC (Pimpri Chinchwad). We build high-performance, SEO-ready websites for PCMC businesses. Get a free website audit today.",
    keywords: "website design pcmc, web design pimpri chinchwad, website development pcmc pune, best website design company pcmc",
    ogTitle: "Website Design in PCMC Pune | Growthik Media",
    ogDescription: "Professional website design in PCMC (Pimpri Chinchwad) — fast, SEO-optimized websites for local businesses. Free consultation available.",
    area: "PCMC",
    city: "Pune",
    ...
    faqs: [
      { q: "Do you serve businesses across all of PCMC — Pimpri, Chinchwad, Akurdi, Nigdi?", a: "Yes. We work with businesses across all of PCMC including Pimpri, Chinchwad, Akurdi, Nigdi, Bhosari, Kalewadi, and Wakad areas. We also serve the broader Pune region." },
      { q: "Can you create a website for a manufacturing company?", a: "Absolutely. We have experience building B2B and industrial websites with product catalogs, material specifications, inquiry forms, and certification showcases. These are designed to rank on Google for industry-specific keywords." },
      { q: "How much does website design cost in PCMC?", a: "A professional business website for PCMC companies typically costs ₹18,000–₹1,20,000 depending on complexity. We provide a transparent, itemized quote. No hidden charges." },
      { q: "Will my PCMC website rank on Google?", a: "Every website includes on-page SEO setup, Google Business Profile optimization, local schema markup, and Core Web Vitals optimization. We also offer ongoing SEO services for sustained ranking growth." },
    ],
  },
  "website-design-company-in-viman-nagar": {
    title: "Web Design in Viman Nagar Pune | Growthik Media",
    description: "Professional web design in Viman Nagar, Pune. We build fast, beautiful, and conversion-focused websites for businesses in Viman Nagar. Get a free quote.",
    keywords: "web design viman nagar, website design company viman nagar pune, website development viman nagar, best web design viman nagar",
    ogTitle: "Web Design in Viman Nagar Pune | Growthik Media",
    ogDescription: "Professional web design in Viman Nagar, Pune — high-performance, SEO-optimized websites that grow your business.",
    area: "Viman Nagar",
    city: "Pune",
    ...
    faqs: [
      { q: "How much does web design cost in Viman Nagar?", a: "Web design in Viman Nagar typically costs ₹20,000–₹1,50,000 for a business website depending on the number of pages, custom features, and complexity. We provide a detailed, transparent quote before any work begins." },
      { q: "Can you redesign my existing website?", a: "Absolutely. We handle complete website redesigns — improving the design, performance, and SEO while preserving your existing content and rankings. Our average redesign client sees a 40% improvement in Google PageSpeed scores." },
      { q: "Do you build websites that rank on Google in Viman Nagar?", a: "Yes. Every website we build includes on-page SEO, local schema markup, Core Web Vitals optimization, and Google Business Profile setup — giving your business the best foundation for ranking in Viman Nagar and Pune." },
      { q: "What is your design process?", a: "We follow a structured 5-step process: Discovery → Wireframing → Design Mockups → Development → Testing & Launch. You're involved at every stage with clear communication and scheduled review meetings." },
    ],
  },
  "website-design-company-in-wakad": {
    title: "Web Design Company in Wakad Pune | Growthik Media",
    description: "Top web design company in Wakad, Pune. Fast, SEO-optimized websites for IT companies, startups, and local businesses. Get a free consultation.",
    keywords: "website design company wakad, web design wakad pune, website development wakad, best web design company wakad pune",
    ogTitle: "Web Design Company in Wakad Pune | Growthik Media",
    ogDescription: "Top website design company in Wakad, Pune — SEO-optimized, conversion-focused websites for Wakad businesses. Free consultation.",
    area: "Wakad",
    city: "Pune",
    primaryService: "Website Design Company",
    ...
    faqs: [
      { q: "Do you work with IT companies and startups in Wakad?", a: "Yes, we have significant experience building websites for IT companies, software agencies, and tech startups in Wakad and the Hinjewadi corridor. Our Next.js development capabilities are particularly well-suited for tech businesses." },
      { q: "Can you create a real estate website for Wakad properties?", a: "Absolutely. We build specialized real estate websites with property listings, filter/search functionality, virtual tour embedding, inquiry forms, EMI calculators, and local area guides — all optimized for Google real estate searches." },
      { q: "How much does a website cost in Wakad?", a: "Our website packages for Wakad businesses start at ₹18,000 for a 5-page brochure site and go up to ₹1,50,000+ for custom web applications. Contact us for a detailed, transparent quote tailored to your requirements." },
      { q: "How quickly can you build a website?", a: "Our typical turnaround for a 10-15 page business website is 3-4 weeks. Rush projects can be accommodated with priority development. We always provide a clear, agreed-upon timeline before we begin work." },
    ],
  },
};
