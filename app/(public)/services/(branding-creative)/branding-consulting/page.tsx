...
const slug = "branding-consulting";
const title = "Brand Consulting Agency in Pune | Growthik Media";
const description = "Expert branding consulting for Pune businesses. Brand audits, rebranding strategy and actionable brand growth roadmaps.";
const h1 = "Brand Consulting Agency in Pune";
const canonical = `https://www.growthikmedia.com/services/${slug}/`;
const features = ["Brand Audit", "Rebranding Strategy", "Brand Roadmap", "Competitor Benchmarking", "Brand Health Check", "Consulting Sessions"];
...
export default function BrandingConsultingPage() {
  const service = "Branding Consulting";
  return (
    <>
      ...
      <main className="bg-(--background) min-h-screen pt-24 overflow-hidden text-(--text-primary) font-sans">
        <header className="relative px-6 lg:px-12 py-20 lg:py-32 flex flex-col items-center text-center bg-(--surface) overflow-hidden border-b border-(--border)">
          ...
          <div className="relative z-10 max-w-5xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-(--text-secondary) font-medium max-w-3xl mx-auto mb-10 leading-relaxed">
              We understand that brand consistency is your biggest hurdle. That's why Growthik Media builds branding systems designed specifically for your needs.
            </p>
        ...
        <section className="px-6 lg:px-12 py-20 bg-(--background)">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-black mb-6 uppercase tracking-tight text-(--text-primary)">Scale Your Brand With Precision {service}</h2>
              ...
              <p className="text-(--text-secondary) font-medium text-lg mb-6 leading-relaxed">
                Generic consulting doesn't work. As a specialist operating in this sector, we've engineered a predictable branding matrix. Our focus is entirely on increasing your brand value.
              </p>
            </div>
