...
const title = "Brand Identity Design Agency in Pune | Growthik Media";
const description = "Professional brand identity design in Pune. Logo, colour palette, typography & brand guidelines for startups and SMEs.";
const h1 = "Brand Identity Design Agency in Pune";
const canonical = `https://www.growthikmedia.com/services/${slug}/`;
const features = ["Logo Design", "Colour Palette", "Typography System", "Brand Guidelines", "Business Card Design", "Stationery Kit"];
...
export default function BrandIdentityPage() {
  ...
  const modifier = "Pune";
  const painPoint = "making a memorable first impression in the Pune market";
