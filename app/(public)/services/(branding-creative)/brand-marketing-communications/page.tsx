...
const slug = "brand-marketing-communications";
const title = "Brand Marketing & Communications Agency Pune | Growthik Media";
const description = "Strategic brand marketing and communications in Pune. Messaging frameworks, PR campaigns and brand voice development.";
const h1 = "Brand Marketing & Communications in Pune";
const canonical = `https://www.growthikmedia.com/services/${slug}/`;
const features = ["Brand Messaging", "Campaign Strategy", "PR Communication", "Brand Voice", "Content Campaigns", "Media Outreach"];
...
export default function BrandMarketingCommsPage() {
  const service = "Brand Marketing";
  return (
    <>
        ...
        <header className="relative px-6 lg:px-12 py-20 lg:py-32 flex flex-col items-center text-center bg-(--surface) overflow-hidden border-b border-(--border)">
          ...
          <div className="relative z-10 max-w-5xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-(--text-secondary) font-medium max-w-3xl mx-auto mb-10 leading-relaxed">
              We understand that scaling your message is your biggest hurdle. That's why Growthik Media builds data-driven revenue systems designed specifically for your needs.
            </p>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-(--text-secondary) font-medium text-lg mb-6 leading-relaxed">
                Generic marketing doesn't work. As a specialist operating in this sector, we've engineered a predictable growth matrix. Our focus is entirely on increasing your customer acquisition while lowering your Cost Per Lead.
              </p>
            </div>
