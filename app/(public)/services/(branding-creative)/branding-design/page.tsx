...
const title = "Branding Design Agency in Pune | Growthik Media";
const description = "Complete branding design in Pune. Visual identity, brand collateral and design systems for modern businesses.";
const h1 = "Branding Design Agency in Pune";
const canonical = `https://www.growthikmedia.com/services/${slug}/`;
const features = ["Visual Identity", "Brand Collateral", "Design System", "Marketing Materials", "Brand Templates", "Print & Digital Assets"];
        ...
        <header className="relative px-6 lg:px-12 py-20 lg:py-32 flex flex-col items-center text-center bg-(--surface) overflow-hidden border-b border-(--border)">
          ...
          <div className="relative z-10 max-w-5xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-(--text-secondary) font-medium max-w-3xl mx-auto mb-10 leading-relaxed">
              We understand that visual impact is your biggest hurdle. That's why Growthik Media builds branding designs specifically for your needs.
            </p>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-(--text-secondary) font-medium text-lg mb-6 leading-relaxed">
                Generic designs don't work. As a specialist operating in this sector, we've engineered a predictable branding matrix. Our focus is entirely on increasing your brand perception.
              </p>
            </div>
