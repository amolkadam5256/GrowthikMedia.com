...
const slug = "brand-strategy";
const title = "Brand Strategy Agency in Pune | Growthik Media";
const description = "Expert brand strategy for Pune businesses. Positioning, competitive analysis, messaging framework and go-to-market planning.";
const h1 = "Brand Strategy Agency in Pune";
const canonical = `https://www.growthikmedia.com/services/${slug}/`;
const features = ["Brand Positioning", "Messaging Framework", "Competitive Analysis", "Audience Research", "Go-to-Market Plan", "Brand Audit"];
        ...
        <header className="relative px-6 lg:px-12 py-20 lg:py-32 flex flex-col items-center text-center bg-(--surface) overflow-hidden border-b border-(--border)">
          ...
          <div className="relative z-10 max-w-5xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-(--text-secondary) font-medium max-w-3xl mx-auto mb-10 leading-relaxed">
              We understand that positioning is your biggest hurdle. That's why Growthik Media builds brand strategies designed specifically for your needs.
            </p>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-(--text-secondary) font-medium text-lg mb-6 leading-relaxed">
                Generic strategies don't work. As a specialist operating in this sector, we've engineered a predictable growth matrix. Our focus is entirely on establishing long-term market leadership.
              </p>
            </div>
