...
const slug = "brochure-design";
const title = "Brochure Design Company in Pune | Growthik Media";
const description = "Professional brochure design in Pune. Company profiles, product brochures, flyers and all print collateral.";
const h1 = "Brochure Design Company in Pune";
const canonical = `https://www.growthikmedia.com/services/${slug}/`;
const features = ["Company Brochures", "Product Catalogues", "Flyers & Leaflets", "Annual Reports", "Event Brochures", "Digital Brochures"];
        ...
        <header className="relative px-6 lg:px-12 py-20 lg:py-32 flex flex-col items-center text-center bg-(--surface) overflow-hidden border-b border-(--border)">
          ...
          <div className="relative z-10 max-w-5xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-(--text-secondary) font-medium max-w-3xl mx-auto mb-10 leading-relaxed">
              We understand that professional presentation is your biggest hurdle. That's why Growthik Media builds brochure designs specifically for your needs.
            </p>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-(--text-secondary) font-medium text-lg mb-6 leading-relaxed">
                Generic designs don't work. As a specialist operating in this sector, we've engineered a predictable branding matrix. Our focus is entirely on increasing your conversion from print.
              </p>
            </div>
