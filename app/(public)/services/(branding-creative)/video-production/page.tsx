...
const title = "Video Production Agency in Pune | Growthik Media";
const description = "Professional video production in Pune. Brand films, product videos, social media reels and explainer videos.";
const h1 = "Video Production Agency in Pune";
const canonical = `https://www.growthikmedia.com/services/${slug}/`;
const features = ["Brand Films", "Product Videos", "Social Media Reels", "Explainer Videos", "Corporate Videos", "YouTube Content"];
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-(--text-secondary) font-medium text-lg mb-6 leading-relaxed">
                Generic videos don't work. As a specialist operating in this sector, we've engineered a predictable branding matrix. Our focus is entirely on increasing your viewer engagement.
              </p>
            </div>
