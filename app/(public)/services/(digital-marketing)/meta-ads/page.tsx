...
export const metadata: Metadata = {
  title: "Meta Ads Agency in Pune | Facebook & Instagram Ads | Growthik Media",
  description: "Performance Meta Ads management in Pune. Facebook & Instagram campaigns for leads, sales and brand awareness.",
  alternates: {
...
export default function MetaAdsPage() {
  ...
  const features = ["Facebook Ads", "Instagram Ads", "Lead Generation", "Retargeting", "Lookalike Audiences", "Creative Testing"];
