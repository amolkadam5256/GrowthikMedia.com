...
const title = "Local SEO Agency in Pune | Growthik Media";
const description = "Best local SEO agency in Pune. Rank in Google Maps and local search results to drive more footfall and local inquiries.";
const h1 = "Local SEO Agency in Pune";
const canonical = `https://www.growthikmedia.com/services/${slug}/`;
const features = ["Google Maps Ranking", "GMB Optimization", "Local Citations", "Local Keywords", "Review Management", "Hyperlocal SEO"];
        ...
        <header className="relative px-6 lg:px-12 py-20 lg:py-32 flex flex-col items-center text-center bg-(--surface) overflow-hidden border-b border-(--border)">
          ...
          <div className="relative z-10 max-w-5xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-(--text-secondary) font-medium max-w-3xl mx-auto mb-10 leading-relaxed">
              We understand that Google Maps visibility is your biggest hurdle. That's why Growthik Media builds local SEO systems designed specifically for your needs.
            </p>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-(--text-secondary) font-medium text-lg mb-6 leading-relaxed">
                Generic SEO doesn't work for local businesses. As a specialist operating in this sector, we've engineered a predictable growth matrix. Our focus is entirely on increasing your local footfall and inquiries.
              </p>
            </div>
