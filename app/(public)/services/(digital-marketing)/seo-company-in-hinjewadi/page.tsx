      ...
      services={[
        {
          ...
          desc: "Comprehensive audits covering crawlability, indexation, Core Web Vitals, schema markup, and site architecture.",
        },
        {
          icon: TrendingUp,
          name: "Keyword Research & Strategy",
          desc: "In-depth keyword research targeting Hinjewadi and Pune-area searches with high commercial intent.",
        },
        {
          icon: Target,
          name: "Local SEO & Map Pack",
          desc: "Dominate Google's local '3-pack' for searches like 'SEO company Hinjewadi near me' with Google Business Profile optimization.",
        },
        {
          icon: Globe,
          name: "On-Page Optimization",
          desc: "Full on-page SEO - title tags, meta descriptions, heading structure, internal linking, and schema markup on every page.",
        },
        {
          icon: BarChart,
          name: "Link Building",
          desc: "White-hat backlink acquisition through content outreach, digital PR, and local citations to build domain authority.",
        },
        {
          icon: Zap,
          name: "E-E-A-T Content Strategy",
          desc: "Expert-level content creation that satisfies Google's Experience, Expertise, Authoritativeness, and Trustworthiness signals.",
        },
      ]}
      faqs={[
        {
