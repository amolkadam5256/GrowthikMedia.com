...
const description = "Leading social media marketing in Pune. Instagram, LinkedIn & Facebook marketing that builds community and drives sales.";
const h1 = "Social Media Marketing Agency in Pune";
const canonical = `https://www.growthikmedia.com/services/${slug}/`;
const features = ["Instagram Marketing", "LinkedIn Growth", "Facebook Ads", "Community Management", "Reel Production", "Social Strategy"];
        ...
        <header className="relative px-6 lg:px-12 py-20 lg:py-32 flex flex-col items-center text-center bg-(--surface) overflow-hidden border-b border-(--border)">
          ...
          <div className="relative z-10 max-w-5xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-(--text-secondary) font-medium max-w-3xl mx-auto mb-10 leading-relaxed">
              We understand that social engagement is your biggest hurdle. That's why Growthik Media builds social media systems designed specifically for your needs.
            </p>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-(--text-secondary) font-medium text-lg mb-6 leading-relaxed">
                Generic updates don't work. As a specialist operating in this sector, we've engineered a predictable growth matrix. Our focus is entirely on increasing your brand's social reach and engagement.
              </p>
            </div>
