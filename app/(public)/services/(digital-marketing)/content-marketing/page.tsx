...
const title = "Content Marketing Agency in Pune | Growthik Media";
const description = "Strategic content marketing in Pune. Blog writing, whitepapers, case studies and content distribution that drives B2B leads.";
const h1 = "Content Marketing Agency in Pune";
const canonical = `https://www.growthikmedia.com/services/${slug}/`;
const features = ["Blog Writing", "Case Studies", "Whitepapers", "Content Strategy", "Distribution", "Lead Magnets"];
        ...
        <header className="relative px-6 lg:px-12 py-20 lg:py-32 flex flex-col items-center text-center bg-(--surface) overflow-hidden border-b border-(--border)">
          ...
          <div className="relative z-10 max-w-5xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-(--text-secondary) font-medium max-w-3xl mx-auto mb-10 leading-relaxed">
              We understand that authority building is your biggest hurdle. That's why Growthik Media builds content systems designed specifically for your needs.
            </p>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-(--text-secondary) font-medium text-lg mb-6 leading-relaxed">
                Generic content doesn't work. As a specialist operating in this sector, we've engineered a predictable growth matrix. Our focus is entirely on increasing your organic lead generation.
              </p>
            </div>
