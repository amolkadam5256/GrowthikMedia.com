...
export const metadata: Metadata = {
  title: "Best Google Ads & PPC Management in Pune | Custom & SEO-Friendly Websites",
  description:
    "Looking for a professional google ads & ppc management company in Pune? We provide custom, SEO-optimized, mobile-responsive website development services for businesses. Call Now!",
  keywords:
    "Google Ads & PPC Management in Pune, SEO Company in Pune, Digital Marketing Agency in Pune, Custom Google Ads & PPC Management Pune",
  alternates: {
    canonical: `${CONTACT_INFO.website}/services/ppc-google-ads`,
  },
  openGraph: {
    title:
      "Best Google Ads & PPC Management in Pune | Custom & SEO-Friendly Websites",
    description:
      "Looking for a professional google ads & ppc management company in Pune? We provide custom, SEO-optimized, mobile-responsive website development services for businesses.",
    url: `${CONTACT_INFO.website}/services/ppc-google-ads`,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Growthik Media - Best Google Ads & PPC Management in Pune",
      },
    ],
    locale: "en_IN",
    type: "website",
  ...
  twitter: {
    ...
    title: "Best Google Ads & PPC Management in Pune",
    description:
            ...
            "@graph": [
              {
                ...
                description:
                  "Best Google Ads & PPC Management in Pune offering custom, SEO-friendly websites.",
              ...
              {
                "@type": "Service",
                "@id": `${CONTACT_INFO.website}/services/ppc-google-ads/#service`,
                name: "Google Ads & PPC Management Services Pune",
                provider: {
                  "@id": `${CONTACT_INFO.website}/#localbusiness`,
                },
                areaServed: {
              ...
              },
              {
                ...
                itemListElement: [
                  ...
                  },
                  {
                    ...
                    position: 3,
                    item: {
                      "@id": `${CONTACT_INFO.website}/services/ppc-google-ads`,
                      name: "Google Ads & PPC Management Company Pune",
                    },
                  },
                ],
              },
              {
                ...
                mainEntity: [
                  {
                    "@type": "Question",
                    name: "What is google ads & ppc management?",
                    acceptedAnswer: {
                      "@type": "Answer",
                  ...
                  {
                    "@type": "Question",
                    name: "Is SEO included in google ads & ppc management?",
                    acceptedAnswer: {
                      "@type": "Answer",
      ...
      >
        ...
        >
          ...
          <div className="relative z-10 max-w-5xl mx-auto flex flex-col items-center px-4 md:px-6">
            <h4 className="font-extrabold uppercase tracking-[0.2em] text-xs md:text-sm text-(--text-primary) mb-6 flex items-center gap-2 bg-(--surface) border border-(--border) px-6 py-2.5 rounded-full shadow-sm">
              ...
              Google Ads & PPC Management Company In Pune
            </h4>
            ...
            <p className="text-base md:text-xl text-(--text-secondary) font-medium max-w-3xl mx-auto mb-12 leading-relaxed text-center px-2">
              Looking for a professional Google Ads & PPC Management in Pune? We
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-black mb-4 uppercase tracking-tight text-(--text-primary)">
                Professional Google Ads & PPC Management for Modern Businesses
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  desc: "We deliver Google Ads & PPC Management services with keyword-optimized headings, internal linking architecture, and schema markup.",
                },
                {
                  icon: Smartphone,
        ...
        <section className="px-6 lg:px-12 py-20 bg-(--background) border-y border-(--border)">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-black mb-4 uppercase tracking-tight text-(--text-primary)">
                Custom Google Ads & PPC Management Services
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                {
                  title: "Business Google Ads & PPC Management",
        ...
        <section className="px-6 lg:px-12 py-20 bg-(--background)">
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
            <div className="lg:w-1/2">
              <h2 className="text-3xl md:text-4xl font-black mb-4 uppercase tracking-tight text-(--text-primary)">
                Google Ads & PPC Management with Built-In SEO Advantage
              </h2>
              ...
              <div className="p-6 bg-(--surface) rounded-xl border border-(--border)">
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    "Google Ads & PPC Management in Pune",
                    "SEO Company in Pune",
                    "Digital Marketing Agency in Pune",
                    "Custom Google Ads & PPC Management Pune",
                  ].map((kw, i) => (
                    <span
                      key={i}
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-black mb-4 uppercase tracking-tight text-(--text-primary)">
                Our Recent Google Ads & PPC Management Projects
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  name: "Priya Sharma",
                  comp: "Retail Brand",
                  text: "Best google ads & ppc management company in Pune! Their SEO-first approach helped us rank on the first page of Google for our key products within 3 months.",
                },
                {
                  name: "Amit Joshi",
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              <h2 className="text-3xl font-black mb-4 uppercase tracking-tight text-(--text-primary)">
                Importance of Custom Google Ads & PPC Management for Business Growth
              </h2>
              ...
              >
                {[
                  ...
                  <Link
                    ...
                    aria-label={`Google Ads & PPC Management Services in ${locData.loc}`}
                  >
                    {locData.loc}
                  </Link>
                ))}
        ...
        <section className="px-6 lg:px-12 py-20 bg-(--surface) border-t border-(--border)">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="bg-(--background) p-8 md:p-12 rounded-3xl border border-(--border) shadow-xl relative overflow-hidden">
              ...
              <h2 className="text-3xl font-black mb-4 uppercase tracking-tight text-(--text-primary)">
                Google Ads & PPC Management Pricing
              </h2>
              <div className="w-16 h-1.5 bg-(--color-primary) mb-8"></div>
              <p className="text-(--text-primary) mb-6 font-bold text-lg">
                Google Ads & PPC Management cost depends on several key factors:
              </p>
              ...
              <p className="text-(--text-secondary) font-medium mb-8">
                We offer affordable google ads & ppc management packages tailored for
            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  {
                    q: "What is google ads & ppc management?",
                  ...
                  {
                    q: "Is SEO included in google ads & ppc management?",
        ...
        >
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10 bg-(--surface) p-10 md:p-16 rounded-[3rem] border border-(--border) shadow-2xl shadow-(--color-primary)/5">
            ...
            <p className="text-xl md:text-2xl text-(--text-secondary) font-medium mb-12 max-w-2xl mx-auto">
              Partner with the best Google Ads & PPC Management in Pune to build a
        ...
        <footer className="px-6 lg:px-12 py-8 bg-(--surface) text-center text-xs font-bold uppercase tracking-widest border-t border-(--border)">
          ...
          >
            ...
            <Link
              ...
              className="text-(--text-secondary) hover:text-(--color-primary) transition-colors"
            >
              How to Choose Google Ads & PPC Management Company
            </Link>
            <span className="text-(--border)" aria-hidden="true">
              •
            </span>
