...
export const metadata: Metadata = {
  title: "Google Ads / PPC Services in Pune | Growthik Media",
  description:
    "Looking for a professional Google Ads / PPC company in Pune? We provide custom, SEO-optimized, Google Ads / PPC services for businesses. Call Now!",
  keywords:
    "Google Ads / PPC Company in Pune, SEO Company in Pune, Digital Marketing Agency in Pune, Custom Google Ads / PPC Pune",
  alternates: {
      ...
      <section className="relative px-6 lg:px-12 py-20 lg:py-32 flex flex-col items-center text-center bg-(--surface) overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-(--text-secondary) font-medium max-w-3xl mx-auto mb-10 leading-relaxed">
            Looking for professional Google Ads / PPC in Pune? We create
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-black mb-4 uppercase tracking-tight text-(--text-primary)">
              Professional Google Ads / PPC for Modern Businesses
            </h2>
            ...
            <p className="text-(--text-secondary) font-medium text-lg max-w-2xl mx-auto">
              ...
              Google Ads / PPC services that look premium and perform exceptionally.
            </p>
          </div>
      ...
      <section className="px-6 lg:px-12 py-20 bg-(--surface) border-t border-(--border)">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
          <div className="lg:w-1/2">
            <h2 className="text-3xl md:text-4xl font-black mb-4 uppercase tracking-tight text-(--text-primary)">
              Google Ads / PPC with Built-In ROI Advantage
            </h2>
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
             ...
             <div className="p-6 bg-(--background) rounded-xl border border-(--border)">
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  "Google Ads / PPC Company in Pune",
                  "SEO Company in Pune",
                  "Digital Marketing Agency in Pune",
                  "Top Google Ads / PPC Services",
                ].map((kw, i) => (
                  <span
                    key={i}
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            <h2 className="text-3xl font-black mb-4 uppercase tracking-tight text-(--text-primary)">
              Importance of Google Ads / PPC for Business Growth
            </h2>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-12 justify-between">
          <div className="md:w-1/2">
            <h2 className="text-3xl md:text-5xl font-black mb-6 uppercase tracking-tight text-white">
              Why We Are the Best Google Ads / PPC Company in Pune
            </h2>
      ...
      <section className="px-6 lg:px-12 py-20 bg-(--surface) border-t border-(--border)">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="bg-(--background) p-8 md:p-12 rounded-3xl border border-(--border) shadow-xl relative overflow-hidden">
            ...
            <h2 className="text-3xl font-black mb-4 uppercase tracking-tight text-(--text-primary)">
              Google Ads / PPC Pricing in Pune
            </h2>
            <div className="w-16 h-1.5 bg-(--color-primary) mb-8"></div>
          ...
          <div>
            ...
            <div className="space-y-4">
              {[
                {
                  q: `What does Google Ads / PPC include?`,
                  a: `Our Google Ads / PPC involves comprehensive planning, execution, and continuous optimization tailored to maximize business impact.`,
                },
                {
