...
const title = "Google Ads Agency in Pune | High ROI PPC | Growthik Media";
const description = "Certified Google Ads agency in Pune. Managing high-converting PPC campaigns with lower CPC and maximum ROI. Free audit.";
const h1 = "Google Ads Agency in Pune";
const canonical = `https://www.growthikmedia.com/services/${slug}/`;
const features = ["Search Ads", "Display Ads", "Remarketing", "Shopping Ads", "Video Ads", "Conversion Tracking"];
        ...
        <header className="relative px-6 lg:px-12 py-20 lg:py-32 flex flex-col items-center text-center bg-(--surface) overflow-hidden border-b border-(--border)">
          ...
          <div className="relative z-10 max-w-5xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-(--text-secondary) font-medium max-w-3xl mx-auto mb-10 leading-relaxed">
              We understand that rising ad costs is your biggest hurdle. That's why Growthik Media builds data-driven PPC systems designed specifically for your needs.
            </p>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-(--text-secondary) font-medium text-lg mb-6 leading-relaxed">
                Generic ad campaigns don't work. As a specialist operating in this sector, we've engineered a predictable growth matrix. Our focus is entirely on increasing your lead quality while lowering your CPC.
              </p>
            </div>
