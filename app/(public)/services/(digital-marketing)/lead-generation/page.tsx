...
export const metadata: Metadata = {
  title: "Lead Generation Agency in Pune | Growthik Media",
  description: "Qualified lead generation for Pune businesses. Multi-channel campaigns across Google, Meta, LinkedIn and email.",
  alternates: {
    canonical: "https://www.growthikmedia.com/services/lead-generation/",
  },
  openGraph: {
    title: "Lead Generation Agency in Pune | Growthik Media",
    description: "Qualified lead generation for Pune businesses. Multi-channel campaigns across Google, Meta, LinkedIn and email.",
    url: `${CONTACT_INFO.website}/services/lead-generation/`,
...
export default function LeadGenerationPage() {
  const serviceName = "Lead Generation";
  const h1 = "Lead Generation Agency in Pune";
  const features = ["Google Ads Leads", "Meta Lead Ads", "LinkedIn Leads", "Landing Page Design", "CRM Integration", "Lead Nurturing"];

  return (
    <>
      <Script
        id="schema-lead-generation"
