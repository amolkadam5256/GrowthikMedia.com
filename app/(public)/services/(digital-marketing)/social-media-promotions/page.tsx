...
export default function SocialMediaPromotionsPage() {
  ...
  const h1 = "Social Media Promotions in Pune";
  const features = ["Paid Promotions", "Viral Campaigns", "Contest Management", "Influencer Collabs", "Event Promotion", "Engagement Boost"];

  return (
    <>
      <Script
        id="schema-social-media-promotions"
      ...
      <main className="bg-(--background) min-h-screen pt-24 overflow-hidden text-(--text-primary) font-sans">
        ...
        <ServiceFAQ 
          faqs={SOCIAL_PROMOTIONS_FAQ} 
          title="Social Promotions: Reach & Engagement"
          subtitle="Expert answers to help you understand how our promotional strategies drive results."
        />
      </main>
    </>
  );
