...
const description = "Expert custom software development in Pune. Scalable web applications, SaaS products and enterprise software solutions.";
const h1 = "Software Development Company in Pune";
const canonical = `https://www.growthikmedia.com/services/${slug}/`;
const features = ["Custom Web Apps", "SaaS Development", "Enterprise Software", "API Integrations", "Cloud Solutions", "Tech Consultation"];
        ...
        <header className="relative px-6 lg:px-12 py-20 lg:py-32 flex flex-col items-center text-center bg-(--surface) overflow-hidden border-b border-(--border)">
          ...
          <div className="relative z-10 max-w-5xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-(--text-secondary) font-medium max-w-3xl mx-auto mb-10 leading-relaxed">
              We understand that scalable infrastructure is your biggest hurdle. That's why Growthik Media builds custom software systems designed specifically for your needs.
            </p>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-(--text-secondary) font-medium text-lg mb-6 leading-relaxed">
                Generic software doesn't work. As a specialist operating in this sector, we've engineered a predictable software matrix. Our focus is entirely on increasing your operational efficiency and system scalability.
              </p>
            </div>
