...
const description = "Top mobile app development in Pune. iOS and Android app development using React Native and Flutter for startups and enterprises.";
const h1 = "Mobile App Development in Pune";
const canonical = `https://www.growthikmedia.com/services/${slug}/`;
const features = ["iOS App Development", "Android Development", "React Native Apps", "Flutter Apps", "App Store Optimization", "Backend Integration"];
      ...
      <main className="bg-(--background) min-h-screen pt-24 overflow-hidden text-(--text-primary) font-sans">
        <header className="relative px-6 lg:px-12 py-20 lg:py-32 flex flex-col items-center text-center bg-(--surface) overflow-hidden border-b border-(--border)">
          ...
          <div className="relative z-10 max-w-5xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-(--text-secondary) font-medium max-w-3xl mx-auto mb-10 leading-relaxed">
              We understand that mobile-first engagement is your biggest hurdle. That's why Growthik Media builds high-performance mobile apps designed specifically for your needs.
            </p>
        ...
        <section className="px-6 lg:px-12 py-20 bg-(--background)">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-black mb-6 uppercase tracking-tight text-(--text-primary)">Scale Your Business With Precision {service}</h2>
              ...
              <p className="text-(--text-secondary) font-medium text-lg mb-6 leading-relaxed">
                Generic apps don't work. As a specialist operating in this sector, we've engineered a predictable software matrix. Our focus is entirely on increasing your user retention and app performance.
              </p>
            </div>
