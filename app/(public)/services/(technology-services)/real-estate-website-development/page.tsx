...
export default function RealEstateWebsiteDevelopmentPage() {
  ...
  const h1 = "Real Estate Website Development in Pune";
  const features = ["Lead Capture Forms", "Property Listings", "Interactive Maps", "CRM Portals", "Admin Sales Tool", "Responsive UX"];

  return (
    <>
      <Script
        id="schema-real-estate-development"
