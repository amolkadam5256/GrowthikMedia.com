...
export const metadata: Metadata = {
  title: "E-commerce Website Development in Pune | Growthik Media",
  description: "Scale your online store with professional e-commerce development in Pune. Shopify, WooCommerce and custom platforms.",
  alternates: {
    canonical: "https://www.growthikmedia.com/services/ecommerce-website-development/",
  },
  openGraph: {
    title: "E-commerce Website Development in Pune | Growthik Media",
    description: "Scale your online store with professional e-commerce development in Pune. Shopify, WooCommerce and custom platforms.",
    url: `${CONTACT_INFO.website}/services/ecommerce-website-development/`,
...
export default function EcommerceWebsiteDevelopmentPage() {
  const serviceName = "E-commerce Website Development";
