...
export default function EducationalWebsiteDevelopmentPage() {
  ...
  const h1 = "Educational Website Development in Pune";
  const features = ["LMS Portals", "Student Dashboards", "Course Cataloging", "Online Exams", "Video Integration", "Payment Gateways"];

  return (
    <>
      <Script
        id="schema-educational-development"
