...
export const metadata: Metadata = {
  title: "Best Website Development in Pune | Custom & SEO-Friendly Websites",
  description:
    "Looking for a professional website development company in Pune? We provide custom, SEO-optimized, mobile-responsive website development services for businesses. Call Now!",
  keywords:
    "Website Development in Pune, SEO Company in Pune, Digital Marketing Agency in Pune, Custom Website Development Pune",
  alternates: {
    canonical: `${CONTACT_INFO.website}/services/website-development`,
  },
  openGraph: {
    title:
      "Best Website Development in Pune | Custom & SEO-Friendly Websites",
    description:
      "Looking for a professional website development company in Pune? We provide custom, SEO-optimized, mobile-responsive website development services for businesses.",
    url: `${CONTACT_INFO.website}/services/website-development`,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Growthik Media - Best Website Development in Pune",
      },
    ],
    locale: "en_IN",
    type: "website",
  ...
  twitter: {
    ...
    title: "Best Website Development in Pune",
    description:
            ...
            "@graph": [
              {
                ...
                description:
                  "Best Website Development in Pune offering custom, SEO-friendly websites.",
              ...
              {
                "@type": "Service",
                "@id": `${CONTACT_INFO.website}/services/website-development/#service`,
              ...
              },
              {
                ...
                itemListElement: [
                  ...
                  },
                  {
                    ...
                    position: 3,
                    item: {
                      "@id": `${CONTACT_INFO.website}/services/website-development`,
                      name: "Website Development Company Pune",
                    },
                  },
                ],
              },
        ...
        >
          ...
          <div className="relative z-10 max-w-5xl mx-auto flex flex-col items-center px-4 md:px-6">
            ...
            <p className="text-base md:text-xl text-(--text-secondary) font-medium max-w-3xl mx-auto mb-12 leading-relaxed text-center px-2">
              Looking for a professional Website Development in Pune? We
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  desc: "We deliver Website Development services with keyword-optimized headings, internal linking architecture, and schema markup.",
                },
                {
                  icon: Smartphone,
        ...
        <section className="px-6 lg:px-12 py-20 bg-(--background)">
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
            <div className="lg:w-1/2">
              <h2 className="text-3xl md:text-4xl font-black mb-4 uppercase tracking-tight text-(--text-primary)">
                Website Development with Built-In SEO Advantage
              </h2>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-black mb-4 uppercase tracking-tight text-(--text-primary)">
                Our Recent Website Development Projects
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  name: "Priya Sharma",
                  comp: "Retail Brand",
                  text: "Best website development company in Pune! Their SEO-first approach helped us rank on the first page of Google for our key products within 3 months.",
                },
                {
                  name: "Amit Joshi",
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              <h2 className="text-3xl font-black mb-4 uppercase tracking-tight text-(--text-primary)">
                Importance of Custom Website Development for Business Growth
              </h2>
              ...
              >
                {[
                  ...
                  <Link
                    ...
                    aria-label={`Website Development Services in ${locData.loc}`}
                  >
                    {locData.loc}
                  </Link>
                ))}
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="bg-(--background) p-8 md:p-12 rounded-3xl border border-(--border) shadow-xl relative overflow-hidden">
              ...
              <p className="text-(--text-primary) mb-6 font-bold text-lg">
                Website Development cost depends on several key factors:
              </p>
              ...
              <p className="text-(--text-secondary) font-medium mb-8">
                We offer affordable website development packages tailored for
        ...
        >
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10 bg-(--surface) p-10 md:p-16 rounded-[3rem] border border-(--border) shadow-2xl shadow-(--color-primary)/5">
            ...
            <p className="text-xl md:text-2xl text-(--text-secondary) font-medium mb-12 max-w-2xl mx-auto">
              Partner with the best Website Development in Pune to build a
