...
export const metadata: Metadata = {
  title: "Next.js Development Services in Pune | Growthik Media",
  description:
    "Looking for a professional Next.js Development company in Pune? We provide custom, SEO-optimized, Next.js Development services for businesses. Call Now!",
  keywords:
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-black mb-4 uppercase tracking-tight text-(--text-primary)">
              Professional Next.js Development for Modern Businesses
            </h2>
      ...
      <section className="px-6 lg:px-12 py-20 bg-(--surface) border-t border-(--border)">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
          <div className="lg:w-1/2">
            <h2 className="text-3xl md:text-4xl font-black mb-4 uppercase tracking-tight text-(--text-primary)">
              Next.js Development with Built-In ROI Advantage
            </h2>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            <h2 className="text-3xl font-black mb-4 uppercase tracking-tight text-(--text-primary)">
              Importance of Next.js Development for Business Growth
            </h2>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <div className="space-y-4">
              {[
                {
                  q: `What does Next.js Development include?`,
                  a: `Our Next.js Development involves comprehensive planning, execution, and continuous optimization tailored to maximize business impact.`,
                },
                {
