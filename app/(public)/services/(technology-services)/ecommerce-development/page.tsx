...
const description = "Professional eCommerce development in Pune. Scaling online stores with Razorpay, inventory management and high-converting UX.";
const h1 = "eCommerce Development Agency in Pune";
const canonical = `https://www.growthikmedia.com/services/${slug}/`;
const features = ["Razorpay Integration", "Inventory Management", "GST Billing", "Product SEO", "Mobile Commerce", "Abandoned Cart Recovery"];
        ...
        <header className="relative px-6 lg:px-12 py-20 lg:py-32 flex flex-col items-center text-center bg-(--surface) overflow-hidden border-b border-(--border)">
          ...
          <div className="relative z-10 max-w-5xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-(--text-secondary) font-medium max-w-3xl mx-auto mb-10 leading-relaxed">
              We understand that scaling your online store is your biggest hurdle. That's why Growthik Media builds high-converting eCommerce systems designed specifically for your needs.
            </p>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-(--text-secondary) font-medium text-lg mb-6 leading-relaxed">
                Generic stores don't work. As a specialist operating in this sector, we've engineered a predictable growth matrix. Our focus is entirely on increasing your online sales and customer retention.
              </p>
            </div>
