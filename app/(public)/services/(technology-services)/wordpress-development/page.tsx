...
const description = "Expert WordPress development in Pune. Custom themes, plugin development and WooCommerce stores with 24/7 support.";
const h1 = "WordPress Development Agency in Pune";
const canonical = `https://www.growthikmedia.com/services/${slug}/`;
const features = ["Custom Theme Design", "Plugin Development", "WooCommerce Stores", "Site Maintenance", "Security Audits", "Speed Optimization"];
...
export default function WordpressDevelopmentPage() {
  const service = "WordPress Development";
  return (
    <>
        ...
        <header className="relative px-6 lg:px-12 py-20 lg:py-32 flex flex-col items-center text-center bg-(--surface) overflow-hidden border-b border-(--border)">
          ...
          <div className="relative z-10 max-w-5xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-(--text-secondary) font-medium max-w-3xl mx-auto mb-10 leading-relaxed">
              We understand that site security and speed is your biggest hurdle. That's why Growthik Media builds WordPress systems designed specifically for your needs.
            </p>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-(--text-secondary) font-medium text-lg mb-6 leading-relaxed">
                Generic themes don't work. As a specialist operating in this sector, we've engineered a predictable software matrix. Our focus is entirely on increasing your site's flexibility and search performance.
              </p>
            </div>
