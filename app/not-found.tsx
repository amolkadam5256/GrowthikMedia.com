...
function NotFoundContent() {
  ...
  return (
    <>
      <div className="min-h-screen bg-white dark:bg-(--color-dark) text-(--color-dark) dark:text-white relative overflow-hidden transition-colors duration-500">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-8 md:px-6 md:py-16">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 animate-[fadeIn_1.3s_ease-in]">
            <span className="text-(--color-dark) font-bold">
              Connect with us:
            </span>
