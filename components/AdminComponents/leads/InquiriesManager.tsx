    ...
    <div className="p-6">
      ...
      <div className="grid gap-4">
        {mockInquiries.map((item) => (
          <div
            key={item.id}
            className="bg-gray-50 dark:bg-white/5 p-4 rounded-xl flex items-center justify-between border border-gray-100 dark:border-white/10 cursor-pointer hover:border-blue-500 transition-colors"
          >
