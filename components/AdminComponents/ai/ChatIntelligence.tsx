          ...
          <div className="flex-1 overflow-y-auto no-scrollbar space-y-1 p-2 bg-[#0b0f14]">
            {filteredLeads.length === 0 ? (
              ...
              filteredLeads.map((lead) => {
                ...
                const lastSession = lead.sessions?.[0];
                  ...
                  >
                    <div className="flex justify-between items-start">
                      <div className="flex items-center gap-3">
                        <div
                          className={`w-8 h-8 rounded-sm flex items-center justify-center text-xs font-black border ${isSelected ? "bg-[#d90b1c] border-[#d90b1c] text-white shadow-[0_0_15px_rgba(217,11,28,0.4)]" : "bg-[#0b0f14] border-[#1f2a36] text-[#4a5568] group-hover:text-[#d90b1c] transition-colors shadow-inner"}`}
                        >
                          {lead.name.charAt(0)}
                        </div>
                        <div className="flex flex-col max-w-[120px]">
                          <h4
                            className={`text-[11px] font-black truncate ${isSelected ? "text-[#d90b1c]" : "text-white"}`}
                          >
                            {lead.name}
                          </h4>
                      ...
                      <div
                        className={`px-1.5 py-0.5 rounded-sm text-[6px] font-black uppercase tracking-[0.2em] border ${isSelected ? "bg-[#d90b1c]/10 text-[#d90b1c] border-[#d90b1c]/20" : "bg-[#0b0f14] text-[#4a5568] border-[#1f2a36]"}`}
                      >
                        {lead.status}
                      </div>
                    </div>
                    ...
                    <div className="flex justify-between items-center mt-1">
                      <div className="flex items-center gap-2.5">
                        <span className="flex items-center gap-1.5 text-[7px] font-black text-[#4a5568] uppercase tracking-[0.2em] bg-[#0b0f14] px-2 py-1 rounded-sm border border-[#1f2a36] shadow-inner">
                          <FiClock size={10} className="text-[#d90b1c]/70" />
