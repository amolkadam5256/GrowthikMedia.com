...
export default function UserManager() {
  ...
  return (
    <div className="p-2 md:p-6 max-w-7xl mx-auto">
      ...
      <div className="bg-white dark:bg-gray-800/40 backdrop-blur-2xl rounded-3xl border border-gray-100 dark:border-gray-700/50 overflow-hidden shadow-xl shadow-gray-200/20 dark:shadow-none">
                ...
                {loading ? (
                  ...
                  filteredUsers.map((user) => (
                    <motion.tr
                      ...
                      key={user.id}
                      className="group hover:bg-gray-50/50 dark:hover:bg-red-900/5 transition-colors duration-300"
                    >
        ...
        {showModal && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative bg-white dark:bg-gray-900 w-full max-w-xl rounded-[2.5rem] overflow-hidden shadow-2xl border border-white/10"
            >
              {/* Modal Banner */}
              <div
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-12 pr-4 py-3.5 bg-gray-50 dark:bg-gray-800/80 border-0 rounded-2xl focus:ring-2 focus:ring-red-500 outline-none transition-all dark:text-white"
                      />
                    </div>
                  </div>
