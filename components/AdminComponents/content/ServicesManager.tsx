    ...
    <div className="max-w-6xl mx-auto space-y-8 animate-fade-in">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 bg-gray-100 dark:bg-white/5 text-gray-900 dark:text-white rounded-xl hover:bg-gray-200 dark:hover:bg-white/10 transition"
          >
            <FiPlus />
            Add Service
          </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {services.map((service) => (
          <div
            key={service.id}
            className="bg-white dark:bg-black rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-white/10 group hover:border-blue-500 transition-colors relative"
          >
            <button
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-gray-50 dark:bg-white/5 px-3 py-2 rounded-lg text-sm font-mono text-gray-500"
                />
              </div>
            </div>
          </div>
